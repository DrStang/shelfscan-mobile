...
// Add this function in your App component
  ...
  return (
      <>
        <div className="h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 pt-safe flex flex-col">
          <div className="flex-1 overflow-y-auto pb-20">
              ...
              {activeTab === 'history' && (
                  <div className="max-w-6xl mx-auto p-8 pt-safe pb-24 min-h-full">
              ...
              {activeTab === 'profile' && (
                  <div className="max-w-6xl mx-auto p-8 pt-safe min-h-screen overflow-hidden">
                          ...
                          <div className="bg-white rounded-xl shadow-lg p-6">
                            ...
                            <div className="border-t pt-4 space-y-3">
                              <button
                                  ...
                                  className="w-full text-left px-4 py-3 bg-gray-50 rounded-lg flex items-center justify-between active:scale-95 transition-transform"
                              >
