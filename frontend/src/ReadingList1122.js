  ...
  return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-6">
        ...
        >
              ...
              {importMethod === 'file' && (
                  <>
                    <p className="text-sm text-gray-600 mb-4">
                      Export your list on a computer and email the CSV to yourself, then download it on your device and upload it here. Alternatively, you can visit shelfscan.xyz on a computer and upload your reading list there (it will sync with this app).
                      <a
                ...
                <div className="mb-6 p-2 bg-indigo-50 rounded-lg">
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">
                      ...
                      <p className="text-sm text-gray-600 mb-4">
                        Due to Goodreads restrictions, your library cannot be directly connected here and must be exported. Note because of this, changes to your library will not be automatically imported. We recommend re-importing your list every 2 weeks, or sooner if your library changes frequently.</p>
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                        <p className="font-medium text-blue-900 mb-2">
                            Unfortunately, Android file selection is currently limited.</p>
                          <p className="text-sm text-blue-900 mb-2">
                            Please visit Shelf Scan on a desktop browser to import your Goodreads reading list CSV:</p>
                            <ol className="text-blue-800 space-y-1 ml-4 list-decimal text-xs">
                              <li>Go to shelfscan.xyz on your computer</li>
                              <li>Log in with your same account</li>
                              <li>Import your reading list there</li>
                              <li>Your list will sync to this device!</li>
                            </ol>
                      </div>
                      {readingList.length > 0 && (
                          <button
          ...
          <div
              className="p-4 border-t border-gray-200 bg-gray-50 flex-shrink-0 mb-10"
              style={{
