                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        >
                                                            ...
                                                            <span className="hidden sm:inline">{i18n.t('editBooks.replaceByBarcode')}</span>
                                                            <span className="sm:hidden"><Barcode className="w-4 h-4" /></span>
                                                        </button>
                                                        <button
                            ...
                            <div className="mt-4 border-2 border-dashed border-green-300 dark:border-green-600 rounded-lg p-4 bg-green-50 dark:bg-gray-700">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        >
                                            <Barcode className="w-4 h-4" />
                                            <span className="hidden sm:inline">{i18n.t('editBooks.addByBarcode')}</span>
                                        </button>
                                        <button
